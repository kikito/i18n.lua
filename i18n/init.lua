...
local dirPath = (...):gsub("%.init$","")

local plural      = require(dirPath .. '.plural')
local interpolate = require(dirPath .. '.interpolate')
local variants    = require(dirPath .. '.variants')
local version     = require(dirPath .. '.version')
